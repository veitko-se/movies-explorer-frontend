...
function Profile({onSignOut, onEdit, onSave, isEditable, isServerError, isServerApplied}) {
  ...
  return (
    <main className="profile">
      <UserForm
        ...
        isButtonVisible={isEditable} onSubmit={onSave} isServerError={isServerError} isServerApplied={isServerApplied} />
